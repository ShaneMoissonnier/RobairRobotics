...
public:
    ...
    void compute_rotation()
    {
        ...
        rotation_done = current_orientation - initial_orientation; // rotation_done = ...;

        // do not forget that rotation_done must always be between -M_PI and +M_PI

        error_rotation = rotation_to_do - rotation_done; // error_rotation = ...;
    ...
    void compute_translation()
    {
        ...
        translation_done = distancePoints(initial_position, current_position); // translation_done = ...
        error_translation = translation_to_do - translation_done;              // error_translation = ...
        ...
        if (cond_translation)
        {
            ...
            error_integral_translation += error_translation; // error_integral_translation = ...
            ROS_INFO("error_integral_translation: %f", error_integral_translation);

            // control of translation with a PID controller
            translation_speed = kpt * error_translation + kit * error_integral_translation + kdt * error_derivation_translation; // translation_speed = ...
